...
class JackalInterfacePlus:
    def __init__(self, cfg):
        ...
        # Create Goals
        self.goalA, self.goalB = self.create_goals(cfg.goal, cfg.costfn.goal_separation)
    ...
    def create_goals(self, goal, separation):
        ...
        # Create a tensor with the two goals
        goals = torch.tensor([goal_1, goal_2], device=self.cfg.mppi.device, dtype=torch.float32)
